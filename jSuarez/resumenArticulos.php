...
<body>
    ...
    ?>
    <main>
    <h2>Resumen de Artículos Vendidos</h2>
    <div class="div-form-estado">
    <form action="resumenArticulos.php" method="POST">
        <div>
...
if (isset($_POST['consultar_articulos']) && isset($username) && $rol == "root") {
    ...
    $ventasPorArticulo = $sqlVenta->getVentasPorArticulo($fecha_inicio, $fecha_fin, 1);

    if (!empty($ventasPorArticulo)) {
        echo '<div id="printableArea">';
        echo '<h3>Resumen de Ventas por Artículos</h3>';
